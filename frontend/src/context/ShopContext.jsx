...
const ShopContextProvider = (props) => {
    ...
    // Function to calculate delivery fee based on delivery option and payment method
    const calculateDeliveryFee = (deliveryOption, paymentMethod) => {
    ...
    const value = {
        products, currency, calculateDeliveryFee,
